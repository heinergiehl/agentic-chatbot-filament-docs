...
The documentation target is `v0.17.1`. **Release status:** Approved. Only the protected exact-source and exact-artifact workflow may publish the buyer-visible release; the GitHub release and attached archive are authoritative.
...
- [Release notes v0.17.1](RELEASE_NOTES_v0.17.1.md)
