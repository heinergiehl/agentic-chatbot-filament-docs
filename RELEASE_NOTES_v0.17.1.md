...
The `v0.17.0` source tag was not promoted to an immutable GitHub release because its protected tag workflow exposed the stale single-replay assertion. Use `v0.17.1` or the Composer constraint `^0.17`.
